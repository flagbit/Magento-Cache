 ...
 * Cache Backend class
 * 
 * This Class provides an improved Version of Zend´s Two-Level Cache
 * 
 * @category  Mage
 * @package   Flagbit_Cache
 * @copyright Copyright (c) 2011 Flagbit GmbH & Co. KG (http://www.flagbit.de/)
 ...
 */
class Flagbit_Cache_Backend_TwoLevels extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    ...
    public function load($id, $doNotTestCacheValidity = false)
    {
        ...
        if ($res === false) {
            ...
            $isLoadedFromSlowCache = true;
        }
        $array = unserialize($res);
        // maybe, we have to refresh the fast cache ?
        if ($this->_options['auto_refresh_fast_cache'] && $isLoadedFromSlowCache == true) {
